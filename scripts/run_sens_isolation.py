...
iso_likelihood_arr = [0.1, 0.2, 0.4, 0.8]
...
for pandemic, R in pandemic_to_R.items():
    for country in country_list:
        for iso_likelihood in iso_likelihood_arr:
            for treatment in treatment_list:
                ...
                treat_win = 2
                outdir = "./simulations/%s/%s/%s/%s_%s_AVS%03i_%s_%s_TS%03i_TW%03i_WIN%02i_ISO%02i"%(model, pandemic.replace("_", ""), country, country, pandemic.replace("_", ""), treatment_start_t, ttt_label, treatment, TS, TW, treat_win, iso_likelihood*100)
                cmd = ["python", "renewal.py", "simulate", "--country", country, "--ndays", "365", "--profile", pandemic,
                       ...
                       "--outdir", outdir,
                       "--iso_likelihood", str(iso_likelihood),
